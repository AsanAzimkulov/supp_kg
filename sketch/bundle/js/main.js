...
const getProductInfo = (product) => {
  const productInfo = {
    ...
    dataDescription: product.getAttribute('data-info'),
  };
  return productInfo
}
...
const generateProductPage = (product) => {
  ...
  const formatedTitle = translateBreaksToHtml(product.dataName);
  console.log(translateBreaksToHtml('1  2'));

  const formatedDescription = translateBreaksToHtml(product.dataDescription);
